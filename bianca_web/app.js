...
const PATCHES = [
  ...
  ["W-BLESSING-KNAPP (Aufgabe statt Gesprächsschleife)", "15.09.", "Gespräch", "Blessing antwortet bei unklaren Schnipseln mit genau einer kurzen Aufgabenfrage, lässt „Ich bin die Neue“, Wohlseinsfrage, Behandlerfrage, Doktor-Notizfrage und den langen KI-Erklärtext weg und hängt eine offene „Sonst noch?“-Frage nur an einen belegten Erfolg. Ein reiner Gruß führt direkt zur Aufgabenfrage. Nach einmal Presence und einmal offener Jobfrage beendet Bianca eine weitere Stille sauber; ein offenes Anliegen wird vorher als Rückrufnotiz gesichert. Alle Kürzungen sind ausschließlich über Blessing-Schalter aktiv."],
