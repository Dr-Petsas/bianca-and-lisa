...
# Der Default steht bewusst im CODE und nicht nur in der .env: die Server-.env
# wird beim Deploy schon zweimal versehentlich ueberschrieben worden sein
# (siehe AGENTS.md "Die .env-Falle") — eine dort verlorene DID heisst, dass
# die Praxis auf dem Default-Mandanten landet.
