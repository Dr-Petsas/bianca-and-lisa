...
def transcribe(
    ...
    *,
    ...
    `nachtrag` und `qwen_sperre` werden unveraendert an `stt.transcribe`
    durchgereicht (W-QWEN-KORREKTOR: spaetes Qwen-Ergebnis fuer den
    asynchronen Korrektor; W-QWEN-SICHER: Live-Sperre je Frage-Kontext)."""
    _reset()
    vorher = _qwen_futur()
    extra: dict[str, Any] = {}
