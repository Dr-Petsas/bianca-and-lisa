...
# Lokales STT auf der 5090 (stt_serve/, Parakeet wie Clara): GESETZT = JEDE
...
# Vorab-Transkript im Stille-Fenster (28.08.2026): das Dock schickt den
# Mitschnitt schon beim Stille-VERDACHT (~150 ms), die Transkription laeuft
# waehrend der Stille-Bestaetigung. Notaus: STT_VORAB=0 => wie vorher.
STT_VORAB = _b("STT_VORAB", True)
