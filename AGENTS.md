...
| Stand | Tag | Anleitung |
| --- | --- | --- |
| **V2.9, 15.09.2026 20:53 (aktuell — Blessing ruhig, relative Auswahl und Terminnotiz ohne Endschleife)** | `telefonki-produktionsstand-v2.9-2026-09-15` | `docs/PRODUKTIONSSTAND-V2.9.md` — Live-Image `ec64bbf0fb63`; ein Thema pro Zug, Frühestwahl bleibt erhalten, Nachricht für die Ärztin als eigener bestätigter Schritt |
